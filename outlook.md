...
- Re-evaluating parameter values at different times in the workflow
...
This makes it hard to define additional steps that analyze output and create result tables.
...
However, this is unsatisfactory because the generation of plots, which is part out our overarching workflow, is outside the scope of the actual JUBE workflow specification and has to be done manually.
...
This way, the full workflow can be defined in JUBE, yet the additional layer adds complexity overall.
